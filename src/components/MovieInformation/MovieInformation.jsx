  ...
  return (
    <Grid container className={classes.containerSpaceAround}>
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <br></br><br></br>
        <Typography fontWeight="bolder" variant="h5" gutterBottom style={{ margintop: '10px'}}>
            Overview
        </Typography>
        ...
        <Grid item container style={{marginTop: '2rem'}}>
          <div className={classes.buttonsContainer}>
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
              <ButtonGroup size="small" variant="outlined" className={classes.join}>
            ...
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
              <ButtonGroup className={classes.join} size="small" variant="outlined">
                <Button onClick={addToFavourites} endIcon={isMovieFavourited ? <FavoriteBorderOutlined/>
                : <Favorite />}>
                ...
                <Button endIcon={<ArrowBack />} sx={{borderColor: 'primary-main'}}>
                  <Typography component={Link} to='/' color="inherit" variant="subtitle3" style={{textDecoration: 'none'}}>
                    Back
                  </Typography>
                </Button>
              </ButtonGroup>
